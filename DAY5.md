...
지금 현재의 기능이 무슨 역할을 하는지 큰 생각의 틀을 잡으실수 있도록 도와드려야겠다.

그렇게해서 과정을 따라가는데 어렵지않게 해드려야겠다고 목표를 잡았다.
...
이외에도 id, class 중에 무엇을, 언제, 왜 쓰나요?

띄어쓰기할때, 탭쓰는게 좋나요?, 스페이스바 쓰는게 좋나요?

질문에 답을 하면서 서로 만들어나가다 보니, 시간이 너무 빨리지나갔고 너무 보람찬 하루였다.
