...
페어분이 처음 배우는것이기 때문에, 난 전체적인 흐름 중에서 현재 만드는부분이 어느 영역에 속하는지 알려주고.

지금 현재의 기능이 무슨 역할을 하는지 생각의 틀을 잡으실수 있도록 도와드려 과정을 따라가는데 어렵지않게 해드려야겠다고 목표를 잡았다.
...
혹여나 잘못 잡혀있는 개념들을 번갈아가며 서로 실시간으로 소통하는 방식으로 진행하기로 결정한것이다.
...
“우선 따라가셔야한다는 압박감에 그냥 코드를 쳐보신게 아닐까?”
...
띄어쓰기할때, 탭쓰는게 좋나요?, 스페이스바 쓰는게 좋나요?

정말 많은 질문에 답을 해드리다보니, 시간이 너무 빨리지나갔고 너무 보람찬 하루였다.
